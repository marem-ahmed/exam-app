...
const QuizResultContext = createContext<QuizResultContextType | undefined>(
  undefined
);
export default function QuizResultProvider({
  children,
}: {
  children: ReactNode;
}) {
  ...
  return (
      ...
      <QuizResultContext.Provider value={{ result, setResult  ,showModel, setShowModel}}>
        {children}
