          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3 mt-4">
                  {/* Label */}
                  <FormLabel className="mt-4 font-bold text-xl">
                  ...
                  <FormControl>
                    ...
                    >
                      {currentQuestion?.answers.map((ele) => (
                        <FormItem
                          key={ele.key}
                          className="flex items-center space-x-3 space-y-0 bg-darkWhite border-2 p-3  rounded-lg"
                        >
                          <FormControl>
                            {/* Radio */}
            ...
            <footer className="flex justify-between gap-4  mt-4 w-full ">
              <Button
                ...
                disabled={step === 0}
                className="bg-mainColor text-white py-1 px- rounded-xl mt-2 border-mainColor w-1/2"
              >
                Back
              </Button>
              ...
              {step === questions.length - 1 ? (
                <Button
                  type="submit"
                  className="bg-mainColor text-white py-1 px-7 rounded-xl mt-2 border-mainColor w-1/2"
                >
                  Submit
                </Button>
              ) : (
