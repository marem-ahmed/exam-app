    ...
    <>
      <main>
        <div className="flex justify-between px-8">
          {/* title */}
          <h2 className="text-2xl text-main-color font-medium	">Quizes</h2>
          {/* view all subject */}
          <div className="text-main-color font-medium text-2xl">View All</div>
        </div>
          ...
          {payload?.subjects.map((subject) => (
            <li key={subject._id} className="w-1/3 p-4">
              ...
              <Link href={{ pathname: "/en/diplomas", query: { subject: subject._id } }}>
                <div className={styles.card} style={{ backgroundImage: `url(${subject.icon})` }}>
