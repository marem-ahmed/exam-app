...
export default function UserCard({ name, avatarUrl, passed, fastestTime }: UserStatsCard) {
  return (
    <main className="px-8">
      <div className="bg-white shadow-md rounded-2xl p-4 flex  gap-8 w-full items-center mb-7">
        {/* Image */}
        <Image src={avatarUrl} alt={`${name} profile`} className=" size-52" width={500} height={500} />
        ...
        <div className=" w-3/4">
          ...
          <div className="flex justify-between text-center ">
            <div className="flex justify-between items-center text-center mt-2">
              <Image src="/assets/icons/true.png" alt="Logo" width={100} height={100} className="mt-8" layout="intrinsic" />
              <div>
            ...
            <div className="flex justify-between text-center mt-2  items-center">
              <Image src="/assets/icons/Frame 5.png" alt="Logo" width={100} height={100} className="mt-8" layout="intrinsic" />
              <div>
