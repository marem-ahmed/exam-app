...
export default function SideBar() {
  ...
  const handelLogout = async () => {
    ...
    await signOut({ callbackUrl: "/en/auth/login" });
  };
        ...
        <div>
          ...
          <nav className="space-y-4 flex flex-col">
            <Link href="dashboard" className={linkClass("/dashboard")}>
              <Image
                src="/assets/icons/Component 4.png"
                alt="Dashboard Icon"
                width={18}
                height={18}
                className="mr-2"
            ...
            <div onClick={handelLogout} className="flex items-center cursor-pointer p-2  font-semibold">
              <Image
